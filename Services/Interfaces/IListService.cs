...
namespace choosing.Services.Interfaces
{
    public interface IListService
    {
        ...
        Task<Guest?> GetInvitadoByDniAsync(string dni);
        Task<Guest?> GetInvitadoByDniAndEventIdAsync(string dni, int eventId);
        ...
        Task UpdateInvitadoAsync(string originalDni, Guest updatedGuest); // Nuevo método
        Task UpdateAccreditStatusAsync(Guest invitado); // Nuevo método
        Task DeleteInvitadoAsync(string dni); // Nuevo método
